package br.nom.belo.marcio.cap3.triangulo;
...
public class TrianguloTest {
	...
	public void testTrianguloInvalido() {
		...
		Triangulo t1 = new Triangulo( p1, p2, p3);
		/*
		 * Como o triângulo acima não é válido, assumo que
		 * o triângulo deve assumir os valores padrão.  
		 */
		assertEquals(0.0, t1.getP1().getX(), 0.1 );
		assertEquals(0.0, t1.getP1().getY(), 0.1 );
		assertEquals(0.0, t1.getP2().getX(), 0.1 );
	...
	public void testTrianguloInvalido2() {
		...
		/*
		 * Após a alteração, o triângulo acima fica inválido,
		 * portanto o triângulo deve voltar aos valores padrão  
		 */
		assertEquals(0.0, t1.getP1().getX(), 0.1 );
		assertEquals(0.0, t1.getP1().getY(), 0.1 );
		assertEquals(0.0, t1.getP2().getX(), 0.1 );
